...
<div class="hero card">
  <div>
    <h1>АСВП «Сокіл» — DevelopMaster</h1>
    <p class="slogan">«ручний штрих у строгому костюмі» — зрозумілий інтерфейс, живі дані, проста навігація.</p>
    @guest
      <div class="mt-20">
  ...
  <div class="card" style="background:#f7fbff">
    ...
    <ul class="mb-0">
      @forelse($posts as $p)
        <li class="mb-8"><span class="badge">post</span> {{ $p->title }}</li>
      @empty
