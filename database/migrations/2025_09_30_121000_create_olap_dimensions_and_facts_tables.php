...
return new class extends Migration
{
    ...
    {
        Schema::connection(config('olap.connection'))
            ->create('dim_dates', function (Blueprint $table) {
        ...
        Schema::connection(config('olap.connection'))
            ->create('dim_users', function (Blueprint $table) {
        ...
        Schema::connection(config('olap.connection'))
            ->create('dim_roles', function (Blueprint $table) {
        ...
        Schema::connection(config('olap.connection'))
            ->create('fact_user_logins', function (Blueprint $table) {
                $table->id();
        ...
        Schema::connection(config('olap.connection'))
            ->create('fact_user_registrations', function (Blueprint $table) {
                $table->id();
                $table->string('date_key', 8)->index();
                $table->unsignedBigInteger('user_key')->nullable()->index();
                $table->string('role_key', 64)->nullable()->index();
        ...
        Schema::connection(config('olap.connection'))
            ->create('fact_user_profile_updates', function (Blueprint $table) {
                $table->id();
                $table->string('date_key', 8)->index();
                $table->unsignedBigInteger('user_key')->nullable()->index();
                $table->string('role_key', 64)->nullable()->index();
